...
export function Navbar({ user, logout, isSidebarExpanded, onMobileMenuToggle }) {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-secondary text-white shadow-base transition-all duration-300 w-full">
      <div
      ...
      >
        ...
        <div className="flex items-center space-x-3 min-w-0">
          ...
          <h1 className="text-base sm:text-lg md:text-xl font-semibold truncate max-w-xs sm:max-w-sm md:max-w-md">
