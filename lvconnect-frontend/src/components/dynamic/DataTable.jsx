...
export function DataTable({
  ...
  return (
    <div className="w-full overflow-x-auto rounded-md border border-gray-200 dark:border-gray-700 shadow-sm">
      {/* ✅ Make sure parent handles vertical scroll, not table */}
      <div className="min-w-full overflow-x-auto">
        {bulkActions.length > 0 && selectedRows.length > 0 && (
          <div className="flex flex-wrap justify-between gap-2 p-4 bg-white dark:bg-gray-900">
                ...
                >
                  {row.getVisibleCells().map((cell) => (
                    <td
                      ...
                      style={{
                        maxWidth:
                          cell.column.id === "actions" ? "15rem" : "auto",
                        whiteSpace:
                          cell.column.id === "title" ? "normal" : "nowrap",
                        overflow: "hidden",
        ...
        {/* Pagination */}
        <div className="flex flex-wrap justify-between items-center px-4 py-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 gap-2">
