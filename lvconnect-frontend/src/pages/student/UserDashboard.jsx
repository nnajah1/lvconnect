        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-3 sm:gap-4 lg:gap-6 min-h-0">
          ...
          {/* Mobile: Horizontal scroll container */}
            ...
            <div className="min-w-[600px] sm:min-w-[700px] lg:min-w-0">
              ...
              >
              {/* Time Column */}
              <div className="flex flex-col text-right text-xs sm:text-sm lg:text-base text-gray-400 min-w-[40px] sm:min-w-[50px] lg:min-w-[60px]">
                {[
                "7:00",
                "8:00",
                "9:00",
              ...
              {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day, index) => (
                ...
                {scheduleItems
                  ...
                  // Always use 70px per hour for alignment on all screens
                  const cellHeight = 70;
