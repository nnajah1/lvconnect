    ...
    public function run(): void
    {
        ...
        foreach ($students as $student) {
            StudentFamilyInformation::create([
                ...
                'mother_religion' => $faker->randomElement(['Catholic', 'Christian', 'Muslim', 'Others']),
                'mother_occupation' => $faker->jobTitle,
                'mother_monthly_income' => $faker->randomElement(['5000', '10000', '15000', '20000']),
                ...
                'father_religion' => $faker->randomElement(['Catholic', 'Christian', 'Muslim', 'Others']),
                'father_occupation' => $faker->jobTitle,
                'father_monthly_income' => $faker->randomElement(['5000', '10000', '15000', '20000']),
                ...
                'guardian_religion' => $faker->randomElement(['Catholic', 'Christian', 'Muslim', 'Others']),
                'guardian_occupation' => $faker->jobTitle,
                'guardian_monthly_income' => $faker->randomElement(['5000', '10000', '15000', '20000']),
